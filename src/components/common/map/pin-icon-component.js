...
export default class PinIcon extends React.Component {
    ...
    onClick(event, lat=0, lng=0) {
        ...
        let mapLink = "https://www.google.com/maps/place//@"+lat+","+lng+",17z/";
        URL.openWindow(mapLink, "_blank");
    }
