...
export default class PinInfo extends  Component {
    ...
    renderBoxInfo () {
        ...
        const onClose = (event) => this.onClose(event, this.props.lat, this.props.lng);
        if(this.state.show == true){
            return(
                <div>
                    <div className="popup-title-wrapper" style={this.props.styleTitle}>
                        <Text
                            text="Wantirna South Cricket Club"
                        />
                    </div>
                    <div className="popup-bot-wrapper" style={this.props.styleDescription}>
                        <Text
                            text="Brian Booth Oval, Queen Street,
                          Perthville"
                        />
                        <div className="popup-bot-button-wrapper" style={this.props.styleButton} onClick={onClose}>
                            <Text
                                text="NEXT"
                            />
                            <Icon
